...
public class OperatorAritmatikaGUI_2511532016 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					OperatorAritmatikaGUI_2511532016 frame = new OperatorAritmatikaGUI_2511532016();
	 ...
	 * Create the frame.
	 */
	public OperatorAritmatikaGUI_2511532016() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(txtBil1.getText().trim().isEmpty()) pesanPeringatan("Bilangan 1 harus diisi");
				else if(txtBil2.getText().trim().isEmpty()) pesanPeringatan("Bilangan 2 harus diisi");
				else {
					try {
