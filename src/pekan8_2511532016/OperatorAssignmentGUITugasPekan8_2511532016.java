...
public class OperatorAssignmentGUITugasPekan8_2511532016 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					OperatorAssignmentGUITugasPekan8_2511532016 frame = new OperatorAssignmentGUITugasPekan8_2511532016();
	...
	//Create the frame
	public OperatorAssignmentGUITugasPekan8_2511532016() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(txtBil1.getText().trim().isEmpty()) pesanPeringatan("Angka harus diisi");
					...
					try {
						...
						int op = cbOperator.getSelectedIndex(); //memilih operator
